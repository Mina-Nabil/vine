...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <script type="text/javascript" src="{{url('assets/js/plugins/revolution/js/extensions/revolution.extension.actions.min.js')}}"></script>
        <script type="text/javascript" src="{{url('assets/js/plugins/revolution/js/extensions/revolution.extension.carousel.min.js')}}"></script>
        <script type="text/javascript" src="{{url('assets/js/plugins/revolution/js/extensions/revolution.extension.kenburn.min.js')}}"></script>
        <script type="text/javascript" src="{{url('assets/js/plugins/revolution/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
        <script type="text/javascript" src="{{url('assets/js/plugins/revolution/js/extensions/revolution.extension.migration.min.js')}}"></script>
        <script type="text/javascript" src="{{url('assets/js/plugins/revolution/js/extensions/revolution.extension.navigation.min.js')}}"></script>
        <script type="text/javascript" src="{{url('assets/js/plugins/revolution/js/extensions/revolution.extension.parallax.min.js')}}"></script>
        <script type="text/javascript" src="{{url('assets/js/plugins/revolution/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
        <script type="text/javascript" src="{{url('assets/js/plugins/revolution/js/extensions/revolution.extension.video.min.js')}}"></script>
    </head>
    <body>
    <!--[if lt IE 8]>
                            ...
                            <ul class="minicart-content-items clearfix">
                                ...
                                <li class="media">
                                    <div class="media-left">
                                        <!-- Image -->
                                        <a href="#">
                                            <img src="assets/img/works/illustrated/4.jpg" class="media-object" alt="Alternative Text">
                                        </a>
                                    </div>
        ...
        <nav class="navbar ws-navbar navbar-default">
            <div class="container">                
                ...
                <div class="ws-logo ws-center">
                    <a href="index.html">
                        <img src="assets/img/logo-white.png" alt="Alternative Text" class="img-responsive">
                    </a>
                </div>
    ...
    <div id="ws-hero-fullscreen" class="rev_slider">
        <ul>   
            <li data-transition="fade" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000">        
                <!-- Background Image -->
                <img src="{{url('assets/img/backgrounds/hero-bg.jpg')}}" alt="Alternative Text" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10"> 
                ...
                <div class="tp-caption ws-hero-title"  
                    ...
                    data-start="1000" 
                    data-responsive_offset="on" 
                    style="z-index: 6;"><h1>A selection of creative <br class="rwd-break"> commissioned works.</h1>
                </div>
                ...
                <div class="tp-caption ws-hero-description"
                    ...
                    data-start="1000"            
                    data-responsive_offset="on" 
                    style="z-index: 7;"><h4>Spanning the fields of illustration, lettering &amp; fine art.</h4>
                </div>
            ...
            <div class="row">
                ...
                <div class="ws-about-content clearfix">
                    <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <p>We are a family of creators – close knit and a little crazy – handcrafting goods at our workshop  New York, USA. We make beautiful products from quality materials because believe each one is a representation of who we are close knit and a little crazy – handcrafting.</p>
                    </div>                
                </div>
                ...
                <div class="ws-parallax-holder">
                    <div class="col-sm-6 col-sm-offset-3">
                        ...
                        <div class="ws-call-btn">
                            <a href="#" >Show all journal items</a>
                        </div>
                    </div>
                </div>
            </div>            
            ...
            <div class="row">                                             
                ...
                <div class="col-sm-6 ws-footer-col">                            
                    ...
                    <div class="ws-footer-about">
                        <p>We are a family of creators – close knit and a little crazy – handcrafting goods at our workshop New York, USA. We make beautiful products from quality materials because believe each one is a representation of who we are close.</p>
                    </div>
                </div>
                ...
                <div class="col-sm-2 ws-footer-col">                    
                    ...
                    <ul class="ws-footer-social">
                        ...
                        <li><a href="#x"><i class="fa fa-twitter fa-lg"></i> Twitter</a></li>
                        <li><a href="#x"><i class="fa fa-instagram fa-lg"></i> Instagram</a></li>
                        <li><a href="#x"><i class="fa fa-pinterest fa-lg"></i> Pinterest</a></li>                        
                    </ul>                    
                </div> 
    ...
    <div class="ws-footer-bar"> 
        <div class="container">
            ...
            <!-- Copyright -->
            <div class="pull-left">
                <p>Handcrafted with love &copy; 2015 All rights reserved.</p>       
            </div>
