...
class Order extends Model
{
    ...
    private static function tableQuery()
    {
        return DB::table("orders")
            ...
            ->groupBy("orders.id", "orders.user_id", "orders.created_at", "orders.delivery_date", "orders.guest_name", "orders.guest_mobn", "orders.total",  "orders.status", "orders.address", "orders.note", "areas.name", "users.name", "orders.area_id",  "orders.dash_user_id", "orders.collected_by_id", "orders.driver_id", "orders.updated_at", "orders.created_at", "orders.paid", "users.mobile");
    }
