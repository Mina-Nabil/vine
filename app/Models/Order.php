...
class Order extends Model
{
    ...
    private static function tableQuery()
    {
        return DB::table("orders")
            ...
            ->groupBy("orders.id", "orders.user_id", "orders.created_at", "orders.delivery_date", "orders.guest_name", "orders.guest_mobn", "orders.status", "orders.address", "orders.note", "areas.name", "users.name", "users.mobile");
    }
